...
const packageMap = {
  'darwin-x64': '@thirteenash/ccline-darwin-x64',
  'darwin-arm64': '@thirteenash/ccline-darwin-arm64',
  'linux-x64': '@thirteenash/ccline-linux-x64',
  'linux-x64-musl': '@thirteenash/ccline-linux-x64-musl',
  'linux-arm64': '@thirteenash/ccline-linux-arm64',
  'linux-arm64-musl': '@thirteenash/ccline-linux-arm64-musl',
  'win32-x64': '@thirteenash/ccline-win32-x64',
  'win32-ia32': '@thirteenash/ccline-win32-x64', // Use 64-bit for 32-bit systems
};
...
if (!packageName) {
  ...
  console.error('Please visit https://github.com/ThirteenAsh/CCometixLine for manual installation');
  process.exit(1);
}
...
if (!fs.existsSync(binaryPath)) {
  ...
  console.error('Please try reinstalling: npm install -g @thirteenash/ccline');
